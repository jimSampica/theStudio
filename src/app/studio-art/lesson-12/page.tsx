        ...
        <main className="container">
            <div className="row">
                <div className="col-md-7">
                    ...
                    <p>Please read about <a href="https://dribbble.com/resources/career/types-of-graphic-design" target="_blank">some common careers in art and design</a>
                    ...
                    <ul className="list-style-alpha">
                        ...
                        <li>
                            If you make logos what type of designer are you most likely?
                        </li>
                        <li>
