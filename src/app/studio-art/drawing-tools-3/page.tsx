...
export default function Page() {
  return (
    <main className="container">
      <h2 className="mt-3 mb-2">Lesson: Drawing Tools 3</h2>
      ...
      <ul className="list-style-alpha">
        ...
        <li>
          Do you prefer working with colored drawing tools or black drawing tools? <em>I prefer to work with...</em>
        </li>
        <li>
          Why might you choose charcoal over graphite? <em>I might choose graphite if...</em>
        </li>
      </ul>
