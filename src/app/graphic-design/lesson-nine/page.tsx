        ...
        <main className="container">
            <div className="row">
                <div className="col-md-7">
                    <h2 className="mt-3 mb-2">Lesson Nine: Copyright</h2>
                    <h4 className="mt-3">Instructions</h4>
                    <p>Please watch <a href="https://app.screencastify.com/v3/watch/pb7054tKiCOgKcHskYC1" target="_blank">Copyright Infringement</a>
