  ...
  return (
    <main className="container">
      ...
      <ol>
        ...
        <li>
          <Link href="/lesson-four?studio-time=2d-art">Lesson Four: Use of Class Time</Link>
        </li>
        <li>
        ...
        <li>
          <Link href="/2d-art/lesson-seven">Lesson Seven: Cleaning</Link>
        </li>
        <li>
          <Link href="/2d-art/lesson-eight">Lesson Eight: Creativity</Link>
        </li>
        <li>
          <Link href="/2d-art/lesson-nine">Lesson Nine: Copyright</Link>
        </li>
      </ol>
    </main>
  );
